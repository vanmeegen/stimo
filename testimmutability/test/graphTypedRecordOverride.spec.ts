...
import {GNode, Graph} from '../src/models/GraphTypedRecordOverride'
import {expect} from 'chai'

describe('typedRecordOverride: access and code completion', () => {
  // constructor
...
describe('typedRecordOverride: graph.moveNodes', () => {
  var graph;
  var initialNodes;
  beforeEach(() => {
