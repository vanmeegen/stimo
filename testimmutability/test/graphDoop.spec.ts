...
import {GNode, Graph} from '../src/models/GraphDoop'
import {expect} from 'chai'

describe('Doop: access and code completion', () => {
  // constructor
  let n:GNode = new GNode("Title", 1, 1, 2, 10, 10);
  ...
  it("can set properties with magic string", ()=> {
    ...
    expect(n.title( "Another").title()).equals("Another");
  });
